...
Overview
LiquidSpike is a continuous--discrete hybrid spiking object detector designed for efficient event-based perception. It selectively introduces continuous latent-state processing into information-critical modules while preserving spike-driven information transmission.
...
LiquidSpike-main/ ├── ultralytics/ │ ├── cfg/ │ ├── data/ │ ├── engine/ │ ├── models/ │ ├── nn/ │ └── utils/ ├── train.py ├── val.py ├── predict.py ├── requirements.txt └── README.md
...
SpikeYOLO 23.1M 4×2 67.2 40.4 Spiking Trans-YOLO 26.3M 4×2 68.6 42.1 LiquidSpike 18.9M 4×2 69.4 41.8
...
SpikeYOLO 23.1M 1×1 52.7 36.1 Spiking Trans-YOLO 26.3M 1×1 54.0 37.8 LiquidSpike 18.9M 1×1 56.2 38.2
